...
<div className="my-8 flex flex-col md:flex-row items-center justify-center gap-4 bg-slate-800/50 p-6 rounded-xl border border-slate-700 font-mono text-sm">
  <div className="flex flex-col items-center">
    <div className="w-16 h-16 rounded-full bg-slate-700 border-2 border-slate-500 flex items-center justify-center text-xl font-bold text-slate-300 shadow-lg">V₀</div>
  </div>
  ...
  <div className="text-emerald-400 font-bold border-b border-dashed border-emerald-400/50 pb-1">-- Contraction --&gt;</div>
  <div className="flex flex-col items-center">
    <div className="w-16 h-16 rounded-full bg-emerald-600 border-2 border-emerald-400 flex items-center justify-center text-xl font-bold text-white shadow-[0_0_15px_rgba(52,211,153,0.5)]">V*</div>
  </div>
</div>
...
<div className="my-8 flex flex-col gap-6 bg-slate-800/50 p-6 rounded-xl border border-slate-700">
  <div className="flex flex-col">
    <span className="text-xs font-bold text-slate-400 mb-2 uppercase tracking-wider">Forward Diffusion (Adding Noise)</span>
    <div className="flex items-center justify-between w-full">
      <div className="px-4 py-2 bg-slate-700 rounded border border-slate-600 text-slate-200">x₀ (Data)</div>
      <div className="flex-1 border-t-2 border-dashed border-slate-600 relative mx-2">
        <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-slate-800 px-2 text-xs text-slate-400 whitespace-nowrap">+ Gaussian Noise</span>
      </div>
      <div className="px-4 py-2 bg-slate-700 rounded border border-slate-600 text-slate-200">x_t</div>
      <div className="flex-1 border-t-2 border-dashed border-slate-600 relative mx-2"></div>
      <div className="px-4 py-2 bg-slate-800 rounded border border-slate-500 text-slate-400 opacity-80">x_T (Prior)</div>
    </div>
  </div>
  
  <div className="flex flex-col">
    <span className="text-xs font-bold text-blue-400 mb-2 uppercase tracking-wider">Reverse Diffusion (Denoising)</span>
    <div className="flex items-center justify-between w-full flex-row-reverse">
      <div className="px-4 py-2 bg-blue-900/40 rounded border border-blue-700/50 text-blue-200">x₀ (Sample)</div>
      <div className="flex-1 border-t-2 border-solid border-blue-700/50 relative mx-2">
         <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-slate-800 px-2 text-xs text-blue-400 text-center leading-tight whitespace-nowrap">Score-based Denoise</span>
      </div>
      <div className="px-4 py-2 bg-slate-700 rounded border border-slate-600 text-slate-200">x_t</div>
      <div className="flex-1 border-t-2 border-solid border-blue-700/50 relative mx-2"></div>
      <div className="px-4 py-2 bg-slate-800 rounded border border-slate-500 text-slate-400 opacity-80">x_T (Prior)</div>
    </div>
  </div>
</div>
...
<div className="my-8 flex flex-col items-center bg-slate-800/50 p-6 rounded-xl border border-slate-700">
  <span className="text-xs font-bold text-slate-400 mb-4 uppercase tracking-wider">SVD Decomposition: A = UΣVᵀ</span>
  <div className="flex flex-row items-center justify-center gap-4">
    <div className="flex flex-col items-center">
      <div className="w-24 h-32 bg-indigo-600/20 border border-indigo-400 rounded flex items-center justify-center text-xl font-mono text-indigo-300 shadow-lg">A</div>
      <span className="text-xs text-slate-400 mt-2">m × n</span>
    </div>
    <div className="text-slate-300 font-bold text-2xl">=</div>
    <div className="flex flex-col items-center">
      <div className="w-16 h-32 bg-blue-600/20 border border-blue-400 rounded flex items-center justify-center text-xl font-mono text-blue-300 shadow-lg">U</div>
      <span className="text-xs text-slate-400 mt-2">m × r</span>
    </div>
    <div className="flex flex-col items-center">
      <div className="w-16 h-16 bg-emerald-600/20 border border-emerald-400 rounded flex items-center justify-center text-xl font-mono text-emerald-300 shadow-lg">Σ</div>
      <span className="text-xs text-slate-400 mt-2">r × r</span>
    </div>
    <div className="flex flex-col items-center">
      <div className="w-32 h-16 bg-purple-600/20 border border-purple-400 rounded flex items-center justify-center text-xl font-mono text-purple-300 shadow-lg">Vᵀ</div>
      <span className="text-xs text-slate-400 mt-2">r × n</span>
    </div>
  </div>
</div>
